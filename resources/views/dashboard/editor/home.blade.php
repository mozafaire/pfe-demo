...
<nav class="navbar navbar-default">
	...
	<div id="navbarCollapse" class="collapse navbar-collapse">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li class="dropdown">
				<a href="#" data-toggle="dropdown" class="dropdown-toggle user-action"><img src="https://www.tutorialrepublic.com/examples/images/avatar/2.jpg" class="avatar" alt="Avatar"> welcom {{Auth::guard('editor')->user()->first_name}} <b class="caret"></b></a>
				<ul class="dropdown-menu">
