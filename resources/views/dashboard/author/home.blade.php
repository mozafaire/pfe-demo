...
<nav class="navbar navbar-default">
	...
	<div id="navbarCollapse" class="collapse navbar-collapse">
		<ul class="nav navbar-nav">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">					
					...
					<li><a href="{{route('author.libre-article')}}">Libre article</a></li>
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li class="dropdown">
				<a href="#" data-toggle="dropdown" class="dropdown-toggle user-action"><img src="https://www.tutorialrepublic.com/examples/images/avatar/2.jpg" class="avatar" alt="Avatar"> welcom {{Auth::user()->first_name}} <b class="caret"></b></a>
				<ul class="dropdown-menu">
